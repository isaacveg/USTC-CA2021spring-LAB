...
//////////////////////////////////////////////////////////////////////////////////
`define DataRamContentLoadPath "C:\\vivadoproject\\project_1\\lab2\\Simulation\\3testAll.data"           //修改此处为测试数据路�?
`define InstRamContentLoadPath "C:\\vivadoproject\\project_1\\lab2\\Simulation\\3testAll.inst"           //修改此处为测试数据路�?
`define DataRamContentSavePath "C:\\vivadoproject\\project_1\\lab2\\Simulation\\DataRamContent3.txt"      //修改此处为测试数据路�?
`define InstRamContentSavePath "C:\\vivadoproject\\project_1\\lab2\\Simulation\\InstRamContent3.txt"      //修改此处为测试数据路�?
